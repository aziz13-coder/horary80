...
class HoraryMasterMainWindow(QMainWindow):
    ...
    def apply_light_theme(self):
        """Apply light theme styling with improved tab design"""
        light_style = """
        QMainWindow {
    ...
    def apply_dark_theme(self):
        """Apply dark theme styling with improved tab design"""
        dark_style = """
        QMainWindow {
        ...
        /* Update toolbar widget background */
        QToolBar > QWidget {
            background-color: #2d2d2d;
        ...
        QPushButton[page_index]:hover {
            background-color: rgba(255, 255, 255, 0.05);
            color: #ffffff;
            border-bottom-color: rgba(100, 181, 246, 0.5);
        }
        
        QPushButton[page_index]:checked {
            color: #64B5F6;
        ...
        # Update toolbar background for dark mode
    ...
    def check_engine_status(self):
        """Check and update engine status with better visual feedback"""
        if HORARY_ENGINE_AVAILABLE:
            ...
            """)
        """Setup the enhanced main toolbar"""
        toolbar = QToolBar("Main Toolbar")
        toolbar.setMovable(False)
        toolbar.setToolButtonStyle(Qt.ToolButtonTextBesideIcon)
        toolbar.setIconSize(QSize(24, 24))
        
        # Navigation actions with proper icons and tooltips
        self.dashboard_action = QAction("📊", self)
        self.dashboard_action.setText("Dashboard")
        self.dashboard_action.setToolTip("View dashboard with recent charts and statistics")
        self.dashboard_action.triggered.connect(lambda: self.switch_page(0))
        
        self.cast_chart_action = QAction("⚡", self)
        self.cast_chart_action.setText("Cast Chart")
        self.cast_chart_action.setToolTip("Cast a new horary chart")
        self.cast_chart_action.triggered.connect(lambda: self.switch_page(1))
        
        self.timeline_action = QAction("📈", self)
        self.timeline_action.setText("Timeline")
        self.timeline_action.setToolTip("View timeline of all charts")
        self.timeline_action.triggered.connect(lambda: self.switch_page(3))
        
        self.notebook_action = QAction("📝", self)
        self.notebook_action.setText("Notebook")
        self.notebook_action.setToolTip("Access research notebook")
        self.notebook_action.triggered.connect(lambda: self.switch_page(4))
        
        # Settings and utility actions
        self.settings_action = QAction("⚙️", self)
        self.settings_action.setText("Settings")
        self.settings_action.setToolTip("Open application settings")
        self.settings_action.triggered.connect(self.show_settings)
        
        # Theme toggle
        self.dark_mode_action = QAction("🌙", self)
        self.dark_mode_action.setText("Dark Mode")
        self.dark_mode_action.setToolTip("Toggle dark/light theme")
        ...
        self.help_action.setToolTip("Show help and documentation")
        self.help_action.triggered.connect(self.show_help)
        
        # Add actions to toolbar
        toolbar.addAction(self.dashboard_action)
        toolbar.addAction(self.cast_chart_action)
        ...
        # Add spacer and status indicators
        spacer = QWidget()
        spacer.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Preferred)
        toolbar.addWidget(spacer)
        
        # Engine status indicator
        self.engine_status_label = QLabel("Engine: Unknown")
        self.engine_status_label.setStyleSheet("color: #666; font-size: 11px; padding: 4px 8px;")
    ...
    def on_page_changed(self, index: int):
        ...
        self.dashboard_action.setChecked(index == 0)
        self.cast_chart_action.setChecked(index == 1)
        self.timeline_action.setChecked(index == 3)
        self.notebook_action.setChecked(index == 4)
